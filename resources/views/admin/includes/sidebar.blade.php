<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-cogs"></i><span class="menu-title"
                                                                                    data-i18n="nav.templates.main">{{ __('dashboard.الاعدادات') }}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{ __('dashboard.وسائل التوصيل') }}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="../vertical-menu-template"
                                   data-i18n="nav.templates.vert.classic_menu">{{ __('dashboard.توصيل مجاني') }}</a>
                            </li>
                            <li><a class="menu-item" href="../vertical-modern-menu-template">{{ __('dashboard.توصيل داخلي') }}</a>
                            </li>
                            <li><a class="menu-item" href="../vertical-compact-menu-template"
                                   data-i18n="nav.templates.vert.compact_menu">{{ __('dashboard.توصيل خارجي') }}</a>
                            </li>
                        </ul>
                    </li>
